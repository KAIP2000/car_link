  ...
  return (
    ...
    //  <Header />
      ...
      <>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-serif font-normal mb-8 text-gray-900">What is <b>Car Link</b>?</h2>
            <div className="max-w-3xl mx-auto space-y-6 text-gray-600">
              <p className="text-lg">
                <b>Car Link</b>, transforming the local car rental market!!! Addressing inefficiencies by connecting drivers with available cars through an intuitive digital marketplace.
              </p>
              <p className="text-lg">
                A core commitment of <b>Car Link</b> is <b>safety</b> and <b>trust</b>. All listed vehicles undergo rigorous verification and inspections to ensure they meet high safety standards, offering peace of mind to both drivers and car owners.
              </p>
              <p className="text-lg">
                For car owners, <b>Car Link</b> provides an opportunity to monetize idle vehicles. Whether an individual car or a fleet, <b>Car Link</b> offers tools, support, and protection to facilitate a successful car-sharing business, contributing to a more efficient and sustainable transportation system in Trinidad.
              </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-50 p-8 rounded-lg text-center">
                ...
                <h3 className="text-xl font-bold mb-3">An easy-to-use website</h3>
                <p className="text-gray-700">
                  Manage your business and bookings seamlessly online—everything you need to run your car rental business is a click away.
                </p>
              </div>
            </div>
          </div>
