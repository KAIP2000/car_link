...
export default function HowCarLinkWorks() {
  ...
  const handleSearch = (dates: { startDate: Date | undefined; endDate: Date | undefined }) => {
    // The navigation is now handled by the SearchForm component
    console.log("Search initiated with dates:", dates)
  }
